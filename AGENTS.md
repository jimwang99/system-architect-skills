...
- Comment why, not what. Never write a docstring or comment that restates the signature or the code. Non-obvious constraints, vendor quirks, units, and preconditions earn a line; self-evident code does not.
