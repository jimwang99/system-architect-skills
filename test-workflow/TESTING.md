...
|---|---|---|---|---|
| 2026-07-25 | 2.1.193 | 0.145.0 | 6.2.0 | act-learn-improve/01 (toy, tier 2, Claude Code only; RED + 2×GREEN at b5479c7); write-adr/01-06 (tier 2, Claude Code only); write-prd/01-08 (tier 2, Claude Code only) |
