...
- State: accepted
- Goal: increment 48 works end to end.
- Covers: PRD-001 REQ-048
...
- State: in-progress
- Goal: increment 49 works end to end.
- Covers: PRD-001 REQ-049
...
- State: planned
- Goal: increment 50 works end to end.
- Covers: PRD-001 REQ-050
