...
- State: accepted
- Goal: increment 10 works end to end.
- Covers: PRD-001 REQ-010
...
- State: in-progress
- Goal: increment 11 works end to end.
- Covers: PRD-001 REQ-011
...
- State: planned
- Goal: increment 12 works end to end.
- Covers: PRD-001 REQ-012
