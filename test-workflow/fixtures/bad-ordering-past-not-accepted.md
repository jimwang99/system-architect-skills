...
- State: paused
- Goal: increment 39 works end to end.
- Covers: PRD-001 REQ-039
...
- State: in-progress
- Goal: increment 40 works end to end.
- Covers: PRD-001 REQ-040
...
- State: planned
- Goal: increment 41 works end to end.
- Covers: PRD-001 REQ-041
