...
- State: accepted
- Goal: increment 57 works end to end.
- Covers: PRD-001 REQ-057
...
- State: in-progress
- Goal: increment 58 works end to end.
- Covers: PRD-001 REQ-058
...
- State: planned
- Goal: increment 59 works end to end.
- Covers: PRD-001 REQ-059
