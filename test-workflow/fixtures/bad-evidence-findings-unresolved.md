...
- State: accepted
- Goal: increment 13 works end to end.
- Covers: PRD-001 REQ-013
...
- State: in-progress
- Goal: increment 14 works end to end.
- Covers: PRD-001 REQ-014
...
- State: planned
- Goal: increment 15 works end to end.
- Covers: PRD-001 REQ-015
