...
- State: accepted
- Goal: increment 16 works end to end.
- Covers: PRD-001 REQ-016
...
- State: in-progress
- Goal: increment 17 works end to end.
- Covers: PRD-001 REQ-017
...
- State: planned
- Goal: increment 18 works end to end.
- Covers: PRD-001 REQ-018
