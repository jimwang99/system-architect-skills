...
- State: accepted
- Goal: increment 19 works end to end.
- Covers: PRD-001 REQ-019
...
- State: in-progress
- Goal: increment 20 works end to end.
- Covers: PRD-001 REQ-020
...
- State: planned
- Goal: increment 21 works end to end.
- Covers: PRD-001 REQ-021
