...
- State: accepted
- Goal: increment 54 works end to end.
- Covers: PRD-001 REQ-054
...
- State: in-progress
- Goal: increment 55 works end to end.
- Covers: PRD-001 REQ-055
...
- State: planned
- Goal: increment 56 works end to end.
- Covers: PRD-001 REQ-056
