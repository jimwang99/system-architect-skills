...
- State: accepted
- Goal: increment 51 works end to end.
- Covers: PRD-001 REQ-051
...
- State: in-progress
- Goal: increment 52 works end to end.
- Covers: PRD-001 REQ-052
...
- State: planned
- Goal: increment 53 works end to end.
- Covers: PRD-001 REQ-053
