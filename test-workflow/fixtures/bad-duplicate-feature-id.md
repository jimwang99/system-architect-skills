...
- State: accepted
- Goal: increment 7 works end to end.
- Covers: PRD-001 REQ-007
...
- State: in-progress
- Goal: increment 8 works end to end.
- Covers: PRD-001 REQ-008
...
- State: planned
- Goal: increment 9 works end to end.
- Covers: PRD-001 REQ-009
