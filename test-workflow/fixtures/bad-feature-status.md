...
- State: accepted
- Goal: increment 28 works end to end.
- Covers: PRD-001 REQ-028
...
- State: in-progress
- Goal: increment 29 works end to end.
- Covers: PRD-001 REQ-029
...
- State: planned
- Goal: increment 30 works end to end.
- Covers: PRD-001 REQ-030
